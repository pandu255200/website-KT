export const chatbotData = {
  "start": {
    "response": [
      { "type": "text", "content": "Hello! Welcome to ResoluteAI Software. How can I help you?" },
  ...
  "services_menu": {
    ...
    "options": [
      ...
      { "text": "Enterprise Mobility Application", "next_id": "service_permit_work" },
      { "text": "Data, AI, ML, Agentic AI & GenAI", "next_id": "service_ehs" },
      { "text": "Cloud Transformation Services", "next_id": "service_logbook" },
      { "text": "IT Services & Tech Support", "next_id": "service_datalake" },
  ...
  "service_permit_work": { "response": [{ "type": "text", "content": "Enterprise Mobility Application: We design and build secure, scalable enterprise mobility applications for Android, iOS, and cross-platform environments. Our solutions streamline field operations, enhance workforce productivity, and enable real-time decision-making through intuitive, performance-driven mobile experiences." },], "options": [{ "text": "See other services", "next_id": "services_menu" }, { "text": "Go to Main Menu", "next_id": "start" }] },
  "service_ehs": { "response": [{ "type": "text", "content": "Data, AI, ML, Agentic AI & GenAI: We help organizations unify, engineer, and govern data through robust data lakes and AI-led architectures. Our solutions enable advanced analytics, predictive insights, autonomous decision systems, and GenAI-driven intelligence tailored to real business use cases." },], "options": [{ "text": "See other services", "next_id": "services_menu" }, { "text": "Go to Main Menu", "next_id": "start" }] },
  "service_logbook": { "response": [{ "type": "text", "content": "Cloud Transformation Services: We enable seamless cloud transformation by modernizing applications, optimizing infrastructure, and ensuring secure cloud adoption. Our cloud services improve scalability, performance, and cost efficiency while supporting business agility and long-term digital growth." },], "options": [{ "text": "See other services", "next_id": "services_menu" }, { "text": "Go to Main Menu", "next_id": "start" }] },
  "service_datalake": { "response": [{ "type": "text", "content": "IT Services & Tech Support: We provide reliable IT services and proactive technical support to ensure business continuity and system stability. From ongoing maintenance to AMC and managed services, we help organizations operate efficiently with minimal downtime and dependable support." },], "options": [{ "text": "See other services", "next_id": "services_menu" }, { "text": "Go to Main Menu", "next_id": "start" }] },
