...
export default function Internships() {
  ...
  const [currentOption, setCurrentOption] = useState("Internships");
        ...
        <div className={Styles.optionToggle}>
          <div
            className={`${Styles.optionItem} ${
              currentOption === "Full Time Jobs" && Styles.activeOption
            }`}
          ...
          <div
            className={`${Styles.optionItem} ${
              currentOption === "Internships" && Styles.activeOption
            }`}
